 ...
 */
let storageTotal = 8000
let currentTotal = 3000
let minuteOfVideo = 150
let spaceAvailable = storageTotal - currentTotal
let videoMinutes = spaceAvailable / minuteOfVideo

let informationString = "You can record \(videoMinutes) more minutes of video"
