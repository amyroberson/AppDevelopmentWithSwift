...
*/
let sitUps = [ 1, 2, 3 ,4 ,5 ,6, 7, 8, 9, 0 ,0, 9, 8,7 ,6, 5, 4, 3, 2, 1, 1, 2,3 ]
...
var index = 0
var dailyNumber = sitUps[index]
func respond(number: Int) -> String {
    if number > 5 {
...
for number in sitUps{
    print(respond(number: number))
}
