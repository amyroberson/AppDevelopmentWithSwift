...
func processResults(forIssue: String, votes: [Bool]) -> String {
    var result = false
    var yes = 0
    var no = 0
    for vote in votes{
    ...
    return "\(forIssue), \(result)"
}

print(processResults(forIssue: "We should change the mascot", votes: shouldMascotChangeVotes))
