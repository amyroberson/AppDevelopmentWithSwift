...
let currentContentSizeInMB = 3000
let ammountIn1MinuteOfVideoInGB = 150

let spaceToFill = iphoneCapacityInMB - currentContentSizeInMB
let howManyMinutes = spaceToFill / ammountIn1MinuteOfVideoInGB
