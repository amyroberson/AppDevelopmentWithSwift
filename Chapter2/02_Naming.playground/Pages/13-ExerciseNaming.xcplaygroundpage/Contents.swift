...
let collectionOfOranges = 14
let collectionOfWatermelons = 3
let orangeWeight = 100
let watermelonWeight = 200
let totalOrangeWeight = collectionOfOranges * orangeWeight
let totalWatermelonWeight = collectionOfWatermelons * watermelonWeight
let total = totalOrangeWeight + totalWatermelonWeight
let totalForOneSide = total / 2
let leftHandside = totalForOneSide / orangeWeight
let rightHandSide = collectionOfOranges - leftHandside
