...
let morningTimeTotal = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch + makeUp + walkDog
...
let thingsIHaveToDo = walkDog + chooseClothes + shower + fixLunch
let thingsILike = makeUp
let thingsIDontDo = finishHomework + goJogging + uploadPhotos
