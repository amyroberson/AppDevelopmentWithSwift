...
let rope = TreehousePulley(weightCapacity: 999)
let megaPulleySystem = TreehousePulley(weightCapacity: 10000)
ricketyRope.canHandleAdditionalLoad(box)
rope.canHandleAdditionalLoad(box)
megaPulleySystem.canHandleAdditionalLoad(box)
